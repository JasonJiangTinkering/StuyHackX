...
class Team(models.Model):
    ...
    users = models.ManyToManyField("users.CustomUser", verbose_name="Team Players", related_name='teams')
    room_sid = models.CharField("Room Sid", max_length=100, blank=True, null=True)
    access_token1 = models.CharField("accesstoken 1", max_length=100, blank=True, null=True)
    access_token2 = models.CharField("accestoken 2", max_length=100, blank=True, null=True)
...
class QueueRoom(models.Model):
    ...
    players_waiting = models.ManyToManyField("users.CustomUser", verbose_name="Players Waiting to Queue")
